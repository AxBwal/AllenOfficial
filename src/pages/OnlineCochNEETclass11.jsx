...
function OnlineCochNEETclass11() {
  return (
    <div>
        <div>
            ...
            <h1 className='text-2xl font-semibold mt-5 px-20'>NEET programs for Class 11th</h1>
            <div className='text-[#bbc2d1] flex mt-4 px-20 gap-4'>
...
export default OnlineCochNEETclass11